...
const Sponsors = () => {
  ...
  */}
      <div className="text-center sm:text-xl md:text-3xl lg:text-4xl xl:text-5xl sm:mt-8 sm:mb-0 space-x-4 mt-8 mb-8 font-palanquin font-bold">
        GOLD
      </div>
      ...
      <div className="text-center sm:text-xl md:text-3xl lg:text-4xl xl:text-5xl sm:mt-8 sm:mb-.5 space-x-4  mb-2 font-palanquin font-bold">
        BRONZE
      </div>
      <div>_____________________________________</div>
      <div className="flex justify-center content-between ">
        <img
          className=" xl:w-24 lg:w-20 lg:h-20  md:w-14 md:h-14 sm:w-10 sm:mr-7 sm:mt-8 mr-8 mb-14"
          src={EA}
          alt="test logo"
        />
        <img
          className="xl:w-60 lg:mr-8 lg:w-44 md:w-28 sm:mt-8 sm:w-28 mr-8 mb-14 "
          src={Google}
          alt="test logo"
        />
        <img
          className="xl:w-60 lg:w-44 md:w-36 sm:mt-8 sm:w-28 sm:mr-8 mb-14 "
          src={Learner}
          alt="test logo"
        />
      </div>
      <div className="text-center sm:text-xl md:text-3xl lg:text-4xl xl:text-5xl  sm:mb-.5 space-x-4  mb-2 font-palanquin font-bold">
